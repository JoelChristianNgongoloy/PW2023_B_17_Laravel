                ...
                <div>
                    <div class="card card-body h-100">
                        ...
                        <div class="row g-3 align-items-center" style="justify-content: space-between;">
                            ...
                            <div class="col-auto">
                                <p>Rp.
                                    {{ number_format($transaksi->mobil['harga_mobil'] + 0.01 * $transaksi->mobil['harga_mobil'] - 0.1 * $transaksi->mobil['harga_mobil'] + 0.05 * $transaksi->mobil['harga_mobil'], 0, ',', '.') }}
                                </p>
                        ...
                        <div class="row g-3 align-items-center" style="justify-content:space-between;">
                            <div class="d-grid gap-2 col-5 mx-auto">
                                <form action="{{ url('delete/' . $transaksi->id) }}" method="POST">
                                    @csrf
                                    @method('delete')
                                    <button class="btn btn-danger" id="batal" style="border-radius: 10px;"><svg
