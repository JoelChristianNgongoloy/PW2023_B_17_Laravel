                ...
                <div>
                    <div class="card card-body h-100">
                        ...
                        <div class="row g-3 align-items-center" style="justify-content: space-between;">
                            ...
                            <div class="col-auto">
                                <p>Rp.
                                    {{ number_format($mobil['harga_mobil'] + 0.01 * $mobil['harga_mobil'] - 0.1 * $mobil['harga_mobil'] + 0.05 * $mobil['harga_mobil'], 0, ',', '.') }}
                                </p>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" style="position: relative">
                                                ...
                                                <div style="position: absolute; top: 0; left: 50%; transform: translateX(-50%); width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; z-index: 2;">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header" style="background-color: #13c9df">
                                                <h1 class="modal-title fs-5" id="paymentModalLabel"
                                                    style="color: white;">Pembayaran Pesanan</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
