...
<body>
    <div class="container">
        ...
        <div class="sideRight">
            ...
            <form id="loginForm" method="POST" class="col-9">
                <div class="col-12">
                    <div class="form-floating mt-5">
                        <input type="input" class="form-control" id="username" placeholder="yourusername" style="border-right: none; border-left: none; border-top: none;" required>
                ...
                <div class="d-grid gap-2 col-5 mt-5 mx-auto">
                    <button class="btn btn-dark btn-lg" type="button" id="loginButton">Log in</button>
                </div>
