...
<body class="hold-transition sidebar-mini">
    <div class="wrapper" style="background-color: #f0f0f0;">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #d2d2d4">
            ...
            <a href="#" class="brand-link" style="background-color: #d0c4c4;width: 260px;; height: 120px; color:black;text-decoration: none; border-bottom: none; padding-top: 50px;margin-left: -10px;">
                <img src=" {{ asset('img/MpLogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-5" style="width: 50px; height: 100px;">
            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('adminMobil') }}" class="nav-link">
                                <i class="nav-icon far fa-circle" style="color: rgba(128, 128, 128, 0.5);"></i>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; {{ date('Y') }} <a href="#">MobilPillihan</a>. </strong> All rights reserved.
        </footer>
    </div>

    <form method="form" action="{{ url('/') }}">
